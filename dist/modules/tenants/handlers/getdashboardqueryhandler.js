...
exports.GetDashboardQueryHandler = void 0;
...
class GetDashboardQueryHandler {
    async execute(q) {
      ...
      WHERE tenant_id = $1;`, [tenantId]);
        ...
        const recentSales = await (0, db_1.query)(`SELECT *
FROM (
  SELECT 
    si.sale_id,
    i.id AS "itemId",
...
`, [tenantId]);
        // Script-based Alerts
        const alerts = await (0, db_1.query)(`SELECT id,
              CASE 
       ...
       LIMIT 10`, [tenantId]);
        ...
        const forecasts = await (0, db_1.query)(`SELECT name AS item,
...
exports.GetDashboardQueryHandler = GetDashboardQueryHandler;
// -----------------------------
// Service Function
// -----------------------------
async function getDashboardService(tenantId) {
