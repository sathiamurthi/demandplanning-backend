...
const ctrl = __importStar(require("./generic"));
const auth_service_1 = require("../../auth/auth.service");
const requestlogger_1 = require("../../middleware/requestlogger");
const EntityRouter = (0, express_1.Router)();
EntityRouter.use(auth_service_1.authMiddleware, auth_service_1.tenantContextMiddleware, requestlogger_1.requestLogger);
