...
const insertIndex = c.indexOf("name: '103_erp_sales_pipeline_and_accounting_phase2'");
if (insertIndex > -1) {
  // Find the end of migration 103
  const nextBracket = c.indexOf("},", insertIndex);
  if (nextBracket > -1) {
    c = c.substring(0, nextBracket + 2) + migration104 + c.substring(nextBracket + 2);
  }
}
